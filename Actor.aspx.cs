      ...
      public void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            String updatedata = "Update Actor set name='" + name.Text + "', dob='" + dob.Text + "',sex='" + sex.Text + "', bio='" + bio.Text + "' where id=" + id.Text;
      ...
      protected void LinkButton5_Click(object sender, EventArgs e)
        {
            ...
            String query = "insert into Actor (name,dob,sex,bio) values('" + name.Text + "','" + dob.Text + "','" + sex.Text + "','" + bio.Text + "')";
            String mycon = "Data Source=DESKTOP-NOTE7LA; Initial Catalog=industry; Integrated Security=true";
            SqlConnection con = new SqlConnection(mycon);
            con.Open();
            SqlCommand cmd = new SqlCommand();
        ...
        public void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            String mycon = "Data Source=DESKTOP-NOTE7LA; Initial Catalog=industry; Integrated Security=True";
            String updatedata = "delete from Actor where id=" + id.Text;
            SqlConnection con = new SqlConnection(mycon);
            con.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = updatedata;
